...
export default function CampaignComposerPage() {
  ...
  const handleCtaClick = () => {
    ...
    fetch('/api/demo', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ action: 'SIMULATE_RESTORE_CART', payload: { cartId: 'cart_abandoned_01' } })
    });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-border">
        <div>
          ...
          <p className="text-xs text-text-muted mt-1">
            Personalized, non-aggressive messaging orchestrated by Campaign Agent and bounded by the Policy Engine.
          </p>
        </div>
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="p-5 rounded-2xl glass-panel border border-border space-y-3">
            ...
            <div className="space-y-1.5 text-xs text-text-secondary">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-accent-cyan">{customer.messagesSentThisWeek} / 2 allowed</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl glass-panel border border-border space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-text-muted">Dynamic Personalization</span>
            </div>
            ...
            <div className="p-2.5 rounded-lg bg-black/40 border border-white/5 text-[11px] text-text-muted">
              <span className="font-bold text-emerald-400">Tone Principle:</span> Helpful and non-intrusive. Avoids high-pressure spam tactics and respects customer attention.
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl glass-panel border border-border space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-surface border border-border">
              <div className="space-y-0.5">
                <div className="text-xs font-semibold text-white">Simulate Delivery Failure</div>
                <div className="text-[10px] text-text-muted">Tests failure logging & bounded retry without spamming</div>
              </div>
              <input
                type="checkbox"
                ...
                <div className="flex items-center gap-1.5 font-bold">
                  {deliveryResult.success ? (
                    <>
                      ...
                      <span>WhatsApp Delivered (ID: {deliveryResult.messageId})</span>
                    </>
                  ) : (
                    <>
            ...
            <div className="w-full h-[620px] rounded-[32px] whatsapp-chat-bg overflow-hidden flex flex-col justify-between border border-black/50 relative">
              ...
              <div className="bg-[#1F2C34] px-4 py-3 flex items-center justify-between text-white border-b border-black/40 z-10">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-xs font-bold leading-tight">Velocity Sports</div>
                ...
                <div className="bg-[#1F2C34] rounded-2xl rounded-tl-sm p-3 border border-white/5 space-y-3 max-w-[95%] shadow-md">
                  ...
                  <div className="pt-2 border-t border-white/10">
                    ...
                    <span className="block text-[9px] text-center text-slate-400 mt-1">
                      Clicking CTA restores saved cart & navigates to safe checkout
                    </span>
                  </div>
