...
export const metadata: Metadata = {
  ...
  description: 'Turn Every Customer Signal Into Revenue. Autonomous growth agents, AI-readable catalogs, bounded policy engines, and explainable payments for merchants.',
};
